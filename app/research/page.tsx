...
import { papers, Paper } from '@/lib/research-data';
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted font-mono mb-4">
                    ...
                    {/* Moved Link Button: Between authors and metadata boxes */}
                    {paper.link && (
                      <div className="mb-4">
                        <a
                          href={paper.link}
